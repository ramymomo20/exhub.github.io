...
MYSQL_POOL_RECYCLE_SECONDS = int(_env("HUB_MYSQL_POOL_RECYCLE_SECONDS", "1800"))
MYSQL_CONNECT_TIMEOUT_SECONDS = int(_env("HUB_MYSQL_CONNECT_TIMEOUT_SECONDS", "10"))
MYSQL_READ_TIMEOUT_SECONDS = int(_env("HUB_MYSQL_READ_TIMEOUT_SECONDS", "15"))
MYSQL_WRITE_TIMEOUT_SECONDS = int(_env("HUB_MYSQL_WRITE_TIMEOUT_SECONDS", "15"))
MYSQL_QUERY_TIMEOUT_SECONDS = int(_env("HUB_MYSQL_QUERY_TIMEOUT_SECONDS", "15"))
